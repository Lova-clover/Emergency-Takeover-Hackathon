    ...
    >
      <div className="container mx-auto px-4 max-w-7xl h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="hidden sm:flex items-center gap-2 px-3 py-1.5 bg-surface border border-border rounded-full text-sm text-muted-foreground hover:bg-muted transition-colors shadow-sm">
